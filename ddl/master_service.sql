...
CREATE TABLE items (
    ...
    item_spec       VARCHAR(200)   DEFAULT NULL COMMENT '표시용 조립 문자열 (예: 100 × 200 × 300 mm)',
    item_width      INT UNSIGNED   DEFAULT NULL COMMENT '너비(mm)',
    item_depth      INT UNSIGNED   DEFAULT NULL COMMENT '깊이(mm)',
    item_height     INT UNSIGNED   DEFAULT NULL COMMENT '높이(mm)',
